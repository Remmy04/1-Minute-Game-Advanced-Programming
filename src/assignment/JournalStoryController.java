...
public class JournalStoryController {
    ...
    public JournalStoryController() {
        System.out.println("JournalStoryController constructor called"); // Debug statement
    }

    @FXML
    private TextArea journalTextArea;
    @FXML
    private Button journalStoryD1NOButton;
    @FXML
    private Button journalStoryD1YESButton;
    @FXML
    private Button goToDayCounterButton;
    @FXML
    private Button goToWinningSceneButton;
    ...
    public void setPrimaryStage(Stage stage) {
        ...
        System.out.println("PrimaryStage in JournalStoryController: " + primaryStage); // Debug statement
    }

    public void setApp(DayCounterApp app) {
        this.app = app;
        System.out.println("App instance set in JournalStoryController: " + app); // Debug statement
        updateTextArea();
    }
    ...
    private void updateTextArea() {
        if (app != null && journalTextArea != null) {
            ...
            System.out.println("App instance or journalTextArea is null!"); // Debug statement
        }
    }
